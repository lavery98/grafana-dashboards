...
| [Node Exporter](https://grafana.com/grafana/dashboards/1860)              | modified | Added lvm disk names, fan speed and hardware voltages. Modified from original using jsonnet |
