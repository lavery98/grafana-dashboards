...
| [Node Exporter](https://grafana.com/grafana/dashboards/1860)              | modified | Added lvm disk names, lvm storage amounts, fan speed and hardware voltages. Modified from original using jsonnet |
